...
def surface(P,Tgeo,dv=0,diw=-1.5,flag='Flase',new_G = False,method='Z17',fit = 3,PV_cal='old'):
    x_fe   = tl2.X_cal_vector(P,Tgeo,dv,np.log10(fiw)+diw,flag=False,method=method,fit= 'fit'+format(fit),PV_cal=PV_cal)
    size   = len(P)
    f_surf = np.zeros(size)
    for i in range(size):
        if i + 2 <  size:
            logf = tl2.fo2_cal_vector(P[:(i + 2)],Tgeo[:(i + 2)],dv[:(i + 2)],
                                      r = x_fe[i],flag=False,new_G=new_G,method=method,fit= 'fit'+format(fit),PV_cal=PV_cal)
        else:
...
fs_25_cold_with_new_G,r_25_cold_with_new_G                 = surface(P,Tgeo,dv=dv_fe_25,diw=-1.5,flag='False',new_G=True,method='mars',fit = 5,PV_cal = '25_cold')
fs_12p5_earth_cold_with_new_G,r_12p5_earth_cold_with_new_G = surface(P,Tgeo,dv=dv_fe_12p5,diw=-2,flag='False',new_G=True,method='earth',fit = 5,PV_cal = '12p5_cold')
fs_12p5_moon_cold_with_new_G, r_12p5_moon_cold_with_new_G  = surface(P,Tgeo,dv=dv_fe_12p5,diw=-2,flag='False',new_G=True,method='moon',fit = 5,PV_cal = '12p5_cold')
...
p_mars_cold_with_new_G,f_mars_cold_with_new_G   = extrapolate_f(P,fs_25_cold_with_new_G,[10,14]);
p_earth_cold_with_new_G,f_earth_cold_with_new_G = extrapolate_f(P,fs_12p5_earth_cold_with_new_G,[25,90]);
p_moon_cold_with_new_G,f_moon_cold_with_new_G   = extrapolate_f(P,fs_12p5_moon_cold_with_new_G,[1,7])
...
p_mars_cold_with_new_G,r_mars_cold_with_new_G   = extrapolate_r(P,r_25_cold_with_new_G,[10,14]);
p_earth_cold_with_new_G,r_earth_cold_with_new_G = extrapolate_r(P,r_12p5_earth_cold_with_new_G,[25,90]);
p_moon_cold_with_new_G,r_moon_cold_with_new_G   = extrapolate_r(P,r_12p5_moon_cold_with_new_G,[1,7])
...
fs_25_hot_with_new_G,r_25_hot_with_new_G                 = surface(P,Tgeo,dv=dv_fe_25,diw=-1.5,flag='False',new_G=True,method='mars',fit = 5,PV_cal = '25_hot')
fs_12p5_earth_hot_with_new_G,r_12p5_earth_hot_with_new_G = surface(P,Tgeo,dv=dv_fe_12p5,diw=-2,flag='False',new_G=True,method='earth',fit = 5,PV_cal = '12p5_hot')
fs_12p5_moon_hot_with_new_G, r_12p5_moon_hot_with_new_G  = surface(P,Tgeo,dv=dv_fe_12p5,diw=-2,flag='False',new_G=True,method='moon',fit = 5,PV_cal = '12p5_hot')
...
p_mars_hot_with_new_G,f_mars_hot_with_new_G   = extrapolate_f(P,fs_25_hot_with_new_G,[10,14]);
p_earth_hot_with_new_G,f_earth_hot_with_new_G = extrapolate_f(P,fs_12p5_earth_hot_with_new_G,[25,90]);
p_moon_hot_with_new_G,f_moon_hot_with_new_G   = extrapolate_f(P,fs_12p5_moon_hot_with_new_G,[1,7])

p_mars_hot_with_new_G,r_mars_hot_with_new_G   = extrapolate_r(P,r_25_hot_with_new_G,[10,14]);
p_earth_hot_with_new_G,r_earth_hot_with_new_G = extrapolate_r(P,r_12p5_earth_hot_with_new_G,[25,90]);
p_moon_hot_with_new_G,r_moon_hot_with_new_G   = extrapolate_r(P,r_12p5_moon_hot_with_new_G,[1,7])
...
ax[0].plot(f_mars_cold,p_mars_cold,'r-',linewidth=1.5)

#ax[0].plot(fs_12p5_earth_cold - np.log10(fiw_cold[0]),P,'b-',alpha=alpha,label='')
ax[0].plot(f_earth_cold,p_earth_cold,'b-',linewidth=1.5)

#ax[0].plot(fs_12p5_moon_cold - np.log10(fiw_cold[0]),P,'g-',alpha=alpha,label='')
ax[0].plot(f_moon_cold,p_moon_cold,'g-',linewidth=1.5)

ax[0].plot(f_mars_cold_with_new_G,p_mars_cold_with_new_G,'r:',linewidth=2.5)

#ax[0].plot(fs_12p5_earth_cold - np.log10(fiw_cold[0]),P,'b-',alpha=alpha,label='')
ax[0].plot(f_earth_cold_with_new_G,p_earth_cold_with_new_G,'b:',linewidth=2.5)

#ax[0].plot(fs_12p5_moon_cold - np.log10(fiw_cold[0]),P,'g-',alpha=alpha,label='')
ax[0].plot(f_moon_cold_with_new_G,p_moon_cold_with_new_G,'g:',linewidth=2.5)
...
ax[1].set_ylim([0,100]);ax[1].set_xlim([0,0.10])
ax[1].invert_yaxis()

### plot Fe3/Fe
#ax[1].plot(r_25_cold,P,'r',label='Mars cold',alpha=alpha)
ax[1].plot(r_mars_cold,p_mars_cold,'r-',linewidth=1.5,label='Deng,2020')

#ax[1].plot(r_12p5_earth_cold,P,'b',label='Earth cold',alpha=alpha)
ax[1].plot(r_earth_cold,p_earth_cold,'b-',linewidth=1.5,label='')

#ax[1].plot(r_12p5_moon_cold,P,'g-',label='Moon cold',alpha=alpha)
ax[1].plot(r_moon_cold,p_moon_cold,'g-',linewidth=1.5,label='')

ax[1].plot(r_mars_cold_with_new_G,p_mars_cold_with_new_G,'r:',linewidth=2.5,label='This Study')

#ax[1].plot(r_12p5_earth_cold,P,'b',label='Earth cold',alpha=alpha)
ax[1].plot(r_earth_cold_with_new_G,p_earth_cold_with_new_G,'b:',linewidth=2.5,label='')

#ax[1].plot(r_12p5_moon_cold,P,'g-',label='Moon cold',alpha=alpha)
ax[1].plot(r_moon_cold_with_new_G,p_moon_cold_with_new_G,'g:',linewidth=2.5,label='')
...
ax[1].plot(np.linspace(0.01,0.04,4),np.zeros_like(np.linspace(0.01,0.04,4))-3.5,'b-',linewidth = 5,clip_on = False,label='')
